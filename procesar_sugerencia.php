...
<body>
    ...
    <?php
        ...
        // Obtener los parámetros del formulario con el método POST
        ...
        // Consulta SQL para insertar la información en la tabla Sugerencias
        $sql = "INSERT INTO Sugerencias (nombre_libro, autor_libro, descripcion_libro, genero_libro, anio_publicacion, idioma_libro, editorial_libro, recomendacion, nombre_usuario, email_usuario) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ssssssssss", $nombre_libro, $autor_libro, $descripcion_libro, $genero_libro, $anio_publicacion, $idioma_libro, $editorial_libro, $recomendacion, $nombre_usuario, $email_usuario);
